...
def test_login_form(driver):
    ...
    # Successful login
    driver.find_element(By.NAME, "username").send_keys("cal@gmail.com")
    driver.find_element(By.NAME, "password").send_keys("123456789")
    driver.find_element(By.CSS_SELECTOR, "mb-1.5 w-full px-6 py-4 bg-[#0080AE] hover:bg-tealDeep text-sm font-semibold text-white rounded-lg shadow-md hover:shadow-lg transition duration-200").click()
    ...
    # Failed login
    driver.find_element(By.NAME, "username").send_keys("cal@gmail.com")
    driver.find_element(By.NAME, "password").send_keys("12345678910")
    driver.find_element(By.CSS_SELECTOR, "mb-1.5 w-full px-6 py-4 bg-[#0080AE] hover:bg-tealDeep text-sm font-semibold text-white rounded-lg shadow-md hover:shadow-lg transition duration-200").click()
